...
app_publisher = "Priyansh"
app_description = "Expense Tracking"
...
website_route_rules = [{'from_route': '/expenses/<path:app_path>', 'to_route': 'expenses'}, {'from_route': '/dashboard/<path:app_path>', 'to_route': 'dashboard'},]